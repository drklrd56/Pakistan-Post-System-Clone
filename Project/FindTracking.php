...
<html>
    ...
    <body>
        ...
        <form action="Handlers/FindTrackingHandler.php" class="Form_Container" method="POST">
            <div class="form-group">
                <div><label class="labl" >CNIC</label></div>
                <textarea class="form-control" name="CNIC" id="" cols="30" rows="5" required></textarea>
            </div>
            <div class="form-group">
            <button style="margin-left: 10%" type="submit" class="btn btn-default" name="Find">FIND</button>
            </div>
        </form>
