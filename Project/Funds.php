...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Fund.php">FundsHistory</a>
                    </li>
        ...
        <div class="Form_Container">
	        <h5 style="text-align:center; margin-bottom: 20px;">PPost Branch Yearly Funds Collections</h5>
            <form action="Handlers/FundHandler.php" method="POST">
                
                <div class="form-group">
                    <div><label class="labl" >Enter Branch PostalCode</label></div>
                    <input class="form-control" name="PostalCode" type="Number" required>
                </div>
                <br>
                <div class="form-group">
                    <div><label class="labl" >Enter Year</label></div>
                    <input class="form-control" name="Year" type="Number" required>
                </div>

                <button style="margin-left: 10%" type="submit" class="btn btn-default" name="Find">Display</button>
            </form>
        </div>
  </div>
</form>
