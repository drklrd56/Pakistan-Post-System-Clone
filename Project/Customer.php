...
<html>
    ...
    <body>
        ...
        <div class="Form_Container">
            <h5 style="text-align:center; margin-bottom: 20px;">Customer Transactions</h5>
	        <form action="Handlers/CustomerHandler.php" method="POST" target="_Blank">
                <div class="form-group">
                    <div><label class="labl" >CustomerID</label></div>
                    <textarea name="CustomerID" id="" cols="30" rows="5" required></textarea>
                </div>
                <button style="margin-left: 10%" type="submit" class="btn btn-default" name="FIND">Search History</button>
            </form>
        </div>
    </body>
</html>